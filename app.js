...
const rawdata = fs.readFileSync("explorers.json"); //Abre el documento
const explorers = JSON.parse(rawdata); //parsea rawdata

// Part 2: Get the quantity of explorers names in node
const explorersInNode = explorers.filter((explorer) => explorer.mission == "node"); //Filtra los explorers que tenga node
